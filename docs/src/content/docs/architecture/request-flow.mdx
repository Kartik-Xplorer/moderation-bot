...
Registered modules include: BotUpdates, AISpam, Languages, Admin, Approvals, Pins, Misc, Bans, Mutes, Purges, Users, Reports, Dev, Locks, Filters, Antiflood, Notes, Connections, Disabling, Rules, Warns, Greetings, Captcha, AntiRaid, Blacklists, Reactions, Formatting, Backup.
...
- **Negative groups**: Early interception — captcha (-10), antiraid (-5), user logging (-1)
- **Group 0**: Standard command handlers (default)
- **Positive groups (3-10)**: Message watchers — aispam (3), antiflood (4), locks (5-6), blacklists (7), reports (8), filters (9), pins (10)
